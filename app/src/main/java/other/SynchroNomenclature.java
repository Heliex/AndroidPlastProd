 ...
 * @version 1.0
 */
public class SynchroNomenclature extends AsyncTask<Void,Void,Void> {
     ...
     */
    public SynchroNomenclature(MainActivity activity) {
    ...
    /**
     * Mets à jour les Nomenclature sur la BDD Distante
     */
    public void MAJ()
    {
        try
