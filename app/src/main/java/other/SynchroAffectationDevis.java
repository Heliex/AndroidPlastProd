 ...
 * @version 1.0
 */
public class SynchroAffectationDevis extends AsyncTask<Void,Void,Void> {
     ...
     */
    public SynchroAffectationDevis(MainActivity activity) {
    ...
    /**
     * Mets à jour les affectationDevis sur la BDD Distante
     */
    public void MAJ()
    {
        try
